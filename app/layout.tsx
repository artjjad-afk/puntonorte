...
export const metadata: Metadata = {
  ...
  description: 'Tienda online de ropa, accesorios, perfumes y cargadores en Venezuela. Moda dama y caballero con calidad premium. Envíos a todo el país desde Barcelona, Anzoátegui. Pago por Binance USDT y Pago Móvil.',
  keywords: [
    ...
    'binance usdt ropa venezuela', 'pago movil ropa', 'cargadores venezuela',
  ],
  ...
  openGraph: {
    ...
    description: 'Ropa dama y caballero, accesorios, perfumes y más. Calidad premium con envíos a toda Venezuela. Pago por Binance USDT y Pago Móvil.',
    url: BASE,
